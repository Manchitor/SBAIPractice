...
-(void)practiceButtonEvent:(SBAIPracticeModel *)item{
    ...
    if (item.supervision && !loginModel.faceFlag){//需要人脸
        ...
        //        SBAIPracticeIntroduceViewController *vc = [[SBAIPracticeIntroduceViewController alloc] initWithNibName:@"SBAIPracticeIntroduceViewController" bundle:[NSBundle mainBundle]];
        //        vc.dataModel = item;
